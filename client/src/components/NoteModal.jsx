        ...
        >
          ...
          >
            ...
            <div className="px-6 py-5 overflow-y-auto max-h-[60vh]">
              ...
              {/* Content */}
              {showPreview ? (
                <div className="markdown-body min-h-[200px] text-surface-700 dark:text-surface-300 rounded-lg p-4 dark:bg-surface-800/50 border border-transparent dark:border-surface-700">
                ...
                <div className="mt-5 pt-4 border-t border-surface-100 dark:border-surface-800">
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center gap-2 py-2">
                      <div className="w-10 h-10 rounded-xl bg-purple-100 dark:bg-primary-500/10
